...
function evdynamics(model::EntryVehicle, x, u)
    ...
    [kdyn(model::EntryVehicle, x[1:8], u,0.9);
     kdyn(model::EntryVehicle, x[9:16], u,1.0);
     kdyn(model::EntryVehicle, x[17:24], u,1.1)]
end
function kdyn(model::EntryVehicle, x, u,kρ)
    ...
    # σ̇ = u
    #atmospheric density
    ρ = atmospheric_density(r, model.evmodel)*kρ
    ...
    return [v[1],v[2],v[3],v̇[1],v̇[2],v̇[3],u[1]*1000, epsilon_dot]
